...
# 轮询取码接口时是否加 _otp_poll 缓存穿透参数。严格校验参数的取码接口
# （如 gxyf-ch.com 会 400 "请求参数无效"）会自动探测并记住跳过，此开关可强制关闭。
OTP_POLL_CACHE_BUST = True
